...
#' data given the weights. npCBPS is similar to [entropy balancing][method_ebal] and will generally produce similar results. Because the optimization problem of npCBPS is not convex it can be slow to converge or
