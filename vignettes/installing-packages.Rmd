...
As with energy balancing, *WeightIt* uses the R package *osqp* to perform the optimization required for CFD balancing; see the instructions above to install it.

For `kernel = "matern"` with a value of `nu` other than 1/2, 3/2, or 5/2, the *GPBayes* package is additionally required to compute the Matern kernel. To install *GPBayes* from CRAN, run
